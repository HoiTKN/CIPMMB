...
def send_email_report(updated_values):
    ...
    if due_rows:
        try:
            ...
            recipients = ["hoitkn@msc.masangroup.com", "mmb-ktcncsd@msc.masangroup.com","haont1@msc.masangroup.com","datnd@msc.masangroup.com","chungnt2@msc.masangroup.com","hattv2@msc.masangroup.com","luannt4@msc.masangroup.com","quangnd2@msc.masangroup.com"]
